...
<body id="top">
    ...
    <div class="tab-news mt-50">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#featured">Jobs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#popular">Skill Development</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="popular" class="container tab-pane fade">
                            @foreach ($motivation['articles'] as $article)
                                @if ($article['urlToImage'])
                                    <div class="tn-news">
                                        <div class="tn-img">
                                            <img src="{{ $article['urlToImage'] }}" />
                ...
                <div class="col-md-6">
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#m-viewed">Most Recent</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#m-read">Most Popular</a>
                        </li>
                    </ul>

                    <div class="tab-content">
                        <div id="m-viewed" class="container tab-pane active">
                            @foreach ($popular['articles'] as $article)
                                @if ($article['urlToImage'])
                                    <div class="tn-news">
                                        <div class="tn-img">
                                            <img src="{{ $article['urlToImage'] }}" />
