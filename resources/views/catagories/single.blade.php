                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-8 col-sm-7 col-4">
                            <div class="header__bottom-right-6 d-flex justify-content-end align-items-center pl-30">
                                ...
                                <div class="dropdown">
                                    @auth
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('edit.details') }}">Edit
                                                Profile</a>
                                            <a class="dropdown-item" href="{{ route('saved.jobs') }}">Saved Jobs</a>
                                            <a class="dropdown-item" href="{{ route('edit.details') }}">Update
                                                Details</a>
                                            <a class="dropdown-item" href="{{ route('edit.cv') }}">Update CV</a>
                                            <a class="dropdown-item"
                                                href="{{ route('applications') }}">Application</a>
                                            <a class="dropdown-item" href="{{ route('accept') }}">Accept</a>
                                            @auth
                                                <a class="dropdown-item">
                                ...
                                <div class="header__btn-7 d-flex align-items-center">
                                    <a href="contact"
                                        class="tp-btnr tp-btn-shine-effect d-none d-sm-inline-block ml-30">Let's
                                        Talk</a>
                                </div>
...
<div class="offcanvas__area offcanvas__area-1 ">
    <div class="offcanvas__wrapper">
            ...
            <div class="mobile-menu-3 fix mb-40">
                @auth
                    <li>
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('profile') }}">View Profile</a>
                            <a class="dropdown-item" href="{{ route('edit.details') }}">Edit Profile</a>
                            <a class="dropdown-item" href="{{ route('saved.jobs') }}">Saved Jobs</a>
        ...
        <div class="offcanvas__contact">
            <p class="offcanvas__contact-mail"><a href="mailto:hello@freelancehub.io">hello@freelancehub.io</a>
            </p>
        </div>
    </div>
</div>
          ...
          <ul class="job-listings mb-5">
            ...
            <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
              ...
              <div class="job-listing-logo">
                <img src="{{asset('asset/images/'.$job->image.'')}}" alt="Free Website Template by Free-Template.co" class="img-fluid">
              </div>
            ...
            <div class="container">
                ...
                <div class="alert alert-success">
                 <p>No jobs in this catagory just yet </p>
                </div>
            @endif
