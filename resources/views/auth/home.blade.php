            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12">
                    <div class="mb-5 text-center">
                        <h6 class="about__heading-title"span class="about__heading-subtitle" style="margin-top: 100px">Find the
                            perfect Freelance services for your business</h6>
                    ...
                    <form method="post" action="{{ route('search.job') }}" class="search-jobs-form">
                        ...
                        <div class="row mb-5" style="margin-top: 50px">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                                <select name="job_region" class="" data-style="btn-white btn-lg" data-width="100%"
