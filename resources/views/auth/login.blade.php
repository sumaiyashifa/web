                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" @if(Session::has('user_email')) value="{{Session::get('user_email')}}" @endif class="form-control" id="email" placeholder="name@example.com" autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="password" name="password"  @if(Session::has('user_password')) value="{{Session::get('user_password')}}" @endif class="form-control" id="password" autocomplete="new-password" required>
                        </div>
                        <div class="mb-3">
