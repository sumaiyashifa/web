...
<body id="top">
    ...
    <div class="offcanvas__area offcanvas__area-1 ">
        <div class="offcanvas__wrapper">
            ...
            <div class="offcanvas__contact">
                <p class="offcanvas__contact-mail"><a href="mailto:hello@JobSearch.io">hello@JobSearch.io</a>
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer__widget footer__widget-7 mb-50 footer-col-7-1">
                                <div class="footer__logo">
                                    <a href="https://JobSearch.io/home-main.html">
                                        <img src="./About - JobSearch_files/logo.svg" alt="">
                                    </a>
                                </div>
                                    ...
                                    <div class="footer__info">
                                        ...
                                        <div class="footer__contact">
                                            <div class="footer__contact-mail">
                                                <span><a
                                                        href="mailto:hello@JobSearch.io">hello@JobSearch.io</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer__widget footer__widget-7 mb-50 footer-col-7-2">
                                ...
                                <div class="footer__widget-content">
                                    <ul>
                                        <li><a href="https://JobSearch.io/">Home</a></li>
                                        <li><a href="https://JobSearch.io/about-us">About</a></li>
                                        <li><a href="{{ route('contact') }}">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-6 col-sm-6"></div>
                            ...
                            <div class="footer__widget footer__widget-7 mb-50 footer-col-7-4">
                                ...
                                <div class="footer__widget-content">
                                    <div class="footer__subscribe-7">
                                        ...
                                        <form action="https://JobSearch.io/about-us" class="newsletterForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-6">
                                <div class="footer__copyright-7 !tw-text-center lg:!tw-text-right">
                                    <p><a href="https://JobSearch.io/">© 2024 JobSearch</a> All Rights Reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
