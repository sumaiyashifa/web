...
<html class="no-js" lang="en" dir="ltr" tp-theme="tp-theme-light" style="--tp-theme-1: #F50963;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
}.tw-h-\[100px\] {height: 100px
}.tw-w-full {width: 100%
}.\!tw-text-center {text-align: center !important
}.tw-text-center {text-align: center
}@media (min-width: 1024px) {.lg\:tw-text-left {text-align: left
    }.lg\:\!tw-text-right {text-align: right !important
    }
}</style></head>
   <body id="top">
...
<!-- offcanvas area end -->
      <main>
         ...
         <section class="tp-section-area p-relative z-index-1 tp-section-spacing">
            <div class="tp-section-bg include-bg" data-background="assets/img/contact/contact-bg.png" style="background-image: url(&quot;assets/img/contact/contact-bg.png&quot;);"></div>
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-xl-7 col-lg-8">
                     <div class="tp-section-wrapper-2 text-center">
                        <h3 class="tp-section-title-2 font-70">Terms and Conditions</h3>
                  ...
                  <div class="col-xl-10">
                     <div class="policy__wrapper policy__translate p-relative z-index-1">
                        <div class="policy__item mb-35">
                           <h4 class="policy__meta">Last updated: December 05, 2022</h4>
                           ...
                           <p>By using or accessing the Services in any manner, you acknowledge that you accept the practices and policies outlined in this Privacy Policy, and you hereby consent that Freelancehub will collect, use, and share your information in the following ways. Remember that your use of Services is at all times subject to the Terms as set forth at https://Freelancehub.io/terms, which incorporate this Privacy Policy. Any terms Freelancehub uses in this Privacy Policy without defining them have the definitions given to them in the Terms.</p>
                        </div>
                        ...
                        <div class="policy__list mb-35">
                           <h3 class="policy__title">Purposes of these Terms and Conditions:</h3>
                           <ul>
                              <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                              <li><strong>Country</strong> refers to: California,  United States</li>
                              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Harry.</li>
                              <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
                              <li><strong>Service</strong> refers to the Website.</li>
                              <li><strong>Website</strong> refers to Freelancehub, accessible from <a href="https://freelancehub.io/" rel="external nofollow noopener" target="_blank">FreelanceHub.io</a></li>
                           </ul>
                        </div>
                        <div class="policy__contact">
                           ...
                           <ul>
                              <li>Email: <span><a href="mailto:hello@freelancehub.io">hello@freelancehub.io</a></span></li>
                           </ul>
