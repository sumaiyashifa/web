    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <form action="{{ route('contact.submits') }}" method="POST" class="contact-form">
            @csrf
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here..." style="font-size: 16px"></textarea>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="block__87154 bg-white rounded">
            ...
            <div class="block__91147 d-flex align-items-center">
              <figure class="mr-4"><img src="{{asset('asset/images/person_2.jpg')}}" alt="Image" class="img-fluid"></figure>
              <div>
                <h3>Chris Peter</h3>
