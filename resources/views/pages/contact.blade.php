...
@section('content')
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="message" id="message" cols="30" rows="7" class="form-control"
                                    placeholder="Write your notes or questions here..." style="font-size: 16px"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="block__87154 bg-white rounded">
                        ...
                        <div class="block__91147 d-flex align-items-center">
                            <figure class="mr-4"><img src="{{ asset('asset/images/person_2.jpg') }}" alt="Image"
    ...
    @include('pages.partials.ai-chat-widget')
