<!DOCTYPE html>
<!-- saved from url=(0030)https://freelancehub.io/policy -->
<html class="no-js" lang="en" dir="ltr" tp-theme="tp-theme-light" style="--tp-theme-1: #F50963;">
...
<head>
    ...
    <script src="./Privacy Policy - FreelanceHub_files/saved_resource"></script>
    <script>
        tailwind.config = {
            prefix: "tw-",
            corePlugins: {
...
<body id="top">
    ...
    <main>
        ...
        <section class="tp-section-area p-relative z-index-1 tp-section-spacing">
            <div class="tp-section-bg include-bg" data-background="assets/img/contact/contact-bg.png"
                style="background-image: url(&quot;assets/img/contact/contact-bg.png&quot;);"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="tp-section-wrapper-2 text-center">
                            <h3 class="tp-section-title-2 font-70">Privacy Policy</h3>
                            <p>Your privacy is important to us. It is FreelanceHub's policy to respect your privacy
                                regarding any information we may collect from you across our website.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-10">
                        <div class="policy__wrapper policy__translate p-relative z-index-1">
                            <div class="policy__item mb-35">
                                <h4 class="policy__meta">Effective date: December 05, 2022</h4>
                                <p>Freelancehub knows that you care about how your personal information is used and
                                    shared, and Freelancehub takes your privacy seriously. Please read the following to
                                    learn more about Freelancehub Privacy Policy (“Privacy Policy”). This Privacy Policy
                                    also tells you about your rights and choices with respect to your Personal
                                    Information, and how you can reach us to update your contact information or get
                                    answers to questions you may have about our privacy practices.</p>
                                <p>By using or accessing the Services in any manner, you acknowledge that you accept the
                                    practices and policies outlined in this Privacy Policy, and you hereby consent that
                                    Freelancehub will collect, use, and share your information in the following ways.
                                    Remember that your use of Services is at all times subject to the Terms as set forth
                                    at https://Freelancehub.io/terms, which incorporate this Privacy Policy. Any terms
                                    Freelancehub uses in this Privacy Policy without defining them have the definitions
                                    given to them in the Terms.</p>
                            </div>

                            <div class="policy__item policy__item-2 mb-35">
                                <h3 class="policy__title">Information Collection</h3>
                                <p>You can visit and enjoy our Website without disclosing any Personal Information about
                                    yourself. However, for the Service to work properly we will need you to share with
                                    us certain Personal Information.</p>

                                <p>For the purposes of this Privacy Policy, “Personal Information” means information
                                    ...
                                    consumer, device or household. It does not include de-identified or aggregate
                                    information, or public information lawfully available from governmental records.</p>
                            </div>
