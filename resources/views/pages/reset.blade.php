                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('updatePassword',['token'=>$token]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control" id="password" placeholder="New Password" autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label for="cpassword" class="form-label">Confirm New Password</label>
                            <input type="password" name="cpassword" class="form-control" id="cpassword" placeholder="Confirm New Password" autocomplete="off" required>
                        </div>
