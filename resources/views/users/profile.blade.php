...
<body id="top">
  <div class="back-to-top-wrapper">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('{{asset('asset/images/hero_1.jpg')}}') ; margin-bottom:100px"  id="home-section">
              ...
              <div class="container">
                ...
                @endif
                    ...
                    <div class="text-center">
                        <img src="{{asset('asset/images/'.$profile->image.'')}}" width="100" class="rounded-circle">
                    </div>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <div>
                            <a href="{{asset('asset/cvs/'.$profile->cv.'')}}" class="btn btn-success  text-white">Download Cv</a>
                        </div>
                    ...
                    <a href="https://www.facebook.com/"  class="pt-3 pb-3 pr-3 pl-0 underline-none"><span class="icon-facebook"></span></a>
