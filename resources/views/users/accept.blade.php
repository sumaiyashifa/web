...
<div class="offcanvas__area offcanvas__area-1 ">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('{{asset('asset/images/hero_1.jpg')}}');" id="home-section">
        <div class="container">
          <div class="row">
            <div class="col-md-7">
                <h1 class="text-white font-weight-bold">Ongoing</h1>
                <div class="custom-breadcrumbs">
                  <a href="#">Home</a> <span class="mx-2 slash">/</span>
                  <a href="#">Job</a> <span class="mx-2 slash">/</span>
                  <span class="text-white"><strong>Accepted</strong></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
              <h2 class="section-title mb-2">Accepted</h2>
            </div>
          </div>
          
          <ul class="job-listings mb-5">
            {{-- @if ($acceptedJobCount->count()>0) --}}
            @foreach ( $acceptedJobs as $job )
            <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
              {{-- <a href="{{route('single.job',$job->job_id)}}"></a> --}}
              <div class="job-listing-logo">
                <img src="{{asset('asset/images/'.$job->job_image.'')}}" alt="Free Website Template by Free-Template.co" class="img-fluid">
              </div>
              ...
              <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                ...
                <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                  <span class="icon-room">{{$job->job_region}}</span> 
                </div>
                <div class="job-listing-meta">
                  <span class="badge badge-danger">{{$job->job_type}}</span>
                </div>
            <div>
              <div class="custom-width w-25">
                <form action="{{ route('submit',['id'=>$job->job_id])}}" method="GET">
                    @csrf
