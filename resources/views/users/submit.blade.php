...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('{{asset('asset/images/hero_1.jpg')}}');" id="home-section">
      ...
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="custom-breadcrumbs">
            ...
            <span class="text-white"><strong>Submitted file</strong></span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="site-section">
    <div class="container">
      ...
      <div class="row mb-5">
        <div class="col-lg-12">
          <form class="p-4 p-md-5 border rounded" enctype="multipart/form-data"  action="{{ route('cd',['id'=>$id]) }}" method="post">
          
           @csrf
          
            <div class="form-group">
              <label for="job-title">Work file </label>
              ...
              <div class="col-lg-4 ml-auto" style="margin-right:10px">
                <div class="row">  
                  <div class="col-6">
                    ...
                    <input type="submit" name="submit" class="btn btn-block btn-primary btn-md" style="margin-top: 50px;" value="submit">
                  </div>
                </div>
            </div>
